...
@Handler(supports={ObsValueAfterDateOfOtherDefinition.class})
public class ObsValueAfterDateOfOtherDefinitionEvaluator implements RowPerPatientDataEvaluator{
	...
	public PatientDataResult evaluate(RowPerPatientData patientData, EvaluationContext context) throws EvaluationException{
		...
		ObsValueAfterDateOfOtherDefinition pd = (ObsValueAfterDateOfOtherDefinition)patientData;
