...
@Handler(supports={EvaluateDefinitionForOtherPersonData.class})
public class EvaluateDefinitionForOtherPatientDataEvaluator implements RowPerPatientDataEvaluator{
	...
	public PatientDataResult evaluate(RowPerPatientData patientData, EvaluationContext context) throws EvaluationException{
		...
		EvaluateDefinitionForOtherPersonData pd = (EvaluateDefinitionForOtherPersonData)patientData;
		EvaluateForOtherPatientDataResult result = new EvaluateForOtherPatientDataResult(pd, context);
